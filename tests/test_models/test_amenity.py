#!/usr/bin/python3
"""
Test Suites for the amenity model
...
class TestAmenityModel(unittest.TestCase):
    ...
    @classmethod
    def setUp(self):
        """ setup resources used in the test """
        self.amenity = Amenity()

    @classmethod
    def tearDown(self):
        """ Tear down the resources after tests """
        del self.amenity

    def test_attributes(self):
        """ Test for attributes of objects """
    ...
    def test_str_method(self):
        """ Test the __str__ on the object """
