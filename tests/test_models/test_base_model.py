#!/usr/bin/python3
""" Tests Suites for the BaseModel """
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_kwargs_init(self):
        ...
        kwargs = {
             "__class__": "BaseModel",
             "created_at": "2025-03-10T19:52:36.252305",
             "id": "83b3c8a8-b72b-1337-9d80-c52b2e090f04",
             "updated_at": "2024-04-11T19:52:36.252312"
            }
...
class TestBaseModelSave(unittest.TestCase):
    ...
    def setUp(self):
        ...
        1st If a file  'file.json' exists, rename it, so its content is not
        interefered with by the tests
        2nd Create Objects of the BaseModel class
        """
    ...
    def tearDown(self):
        ...
        1st Delete the 'file.json' that was created
         If 'file.json' was renamed to 'tmpfile' is the setup,
        2nd Rename it back to 'file.json'
        3rd Delete the objects created during setUp
        """
        if os.path.isfile("file.json"):
            os.remove("file.json")
