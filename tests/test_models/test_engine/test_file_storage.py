...
class TestFileStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        1st If 'file.json' exists, rename it to 'tempfile'
        2nd Initialize objects
        """
    ...
    def tearDown(self):
        ...
        1st Rename 'tempfile' back to 'file.json'
        2nd Delete the objects created during the tests
        """
    ...
    def test_reload_method(self):
        ...
        1st Create a temporaty BaseModel object
        2nd Call save on the object
        3rd call reload on the storge object and verify that the new
        temporaty object exists in the storage object
        4th Delete temporary object
        """
        self.storage.save()
